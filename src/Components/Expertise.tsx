...
const Expertise: React.FC = () => {
  ...
  const handleActionClick = (actionType: 'schedule' | 'learn' | 'chatbot') => {
    // Redirect to login for schedule and learn actions
    if (actionType === 'schedule' || actionType === 'learn') {
      navigate('/login');
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <motion.button 
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={() => handleActionClick('chatbot')}
          >
            <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
